...
const Footer = () => {
    ...
    return (
        <footer className="py-6 px-4 w-full max-w-6xl mx-auto border-t mt-auto">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <ul className="flex gap-4 text-muted-foreground">
                    <li><Link to="/" className={link}><Twitter size={18} /></Link></li>
                    <li><Link to="/" className={link}><Github size={18} /></Link></li>
                    <li><Link to="/" className={link}><Linkedin size={18} /></Link></li>
                </ul>
            </div>
        </footer>
    );
